        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-lg">
                ...
                <div class="flex justify-between px-6 py-4 border-b border-gray-400">
                    <h5 class="text-lg font-semibold">{{ $editId ? 'Ubah' : 'Tambah' }} Banner</h5>
                ...
                <form wire:submit.prevent="save" enctype="multipart/form-data">
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            @enderror
                            @if ($oldImage)
                                <img src="{{ $oldImage && Storage::disk('public')->exists('banner/' . $oldImage)
                                    ? asset('storage/banner/' . $oldImage)
                    ...
                    @foreach ($this->datas as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 {{ $item->periode_color }}">
                                {{ $item->getPeriodeDisplayAttribute() }} <br>
