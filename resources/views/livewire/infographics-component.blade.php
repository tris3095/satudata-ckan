                ...
                <form wire:submit.prevent="save" enctype="multipart/form-data">
                    <div class="px-6 py-4 space-y-4">
                        ...
                        <div>
                            ...
                            @enderror
                            @if ($oldImage)
                                <img src="{{ $oldImage && Storage::disk('public')->exists('infographics/' . $oldImage)
                                    ? asset('storage/infographics/' . $oldImage)
                        ...
                        <div>
                            ...
                            <input wire:model.live.debounce.500ms="source" type="text"
                                placeholder="Contoh: BPS, Kementerian, dsb"
                                class="w-full border rounded-md p-2
        @error('source') border-red-500 @enderror">
