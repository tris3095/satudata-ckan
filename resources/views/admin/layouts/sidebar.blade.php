<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 text-sm space-y-1">
       ...
       {{ request()->routeIs('admin.banner.index')
        ...
        <a href="{{ route('admin.brs.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg transition
       {{ request()->routeIs('admin.brs.index')
           ? 'bg-red-50 text-red-700 font-semibold shadow-sm'
           : 'text-gray-700 hover:bg-gray-100' }}">
       ...
       {{ request()->routeIs('admin.webinar.index')
        ...
        <a href="{{ route('admin.survei-pertanyaan.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg transition
       {{ request()->routeIs('admin.survei-pertanyaan.index')
           ? 'bg-red-50 text-red-700 font-semibold shadow-sm'
           : 'text-gray-700 hover:bg-gray-100' }}">
        ...
        <a href="{{ route('admin.survei-jawaban.index') }}"
            class="flex items-center gap-3 px-3 py-2 rounded-lg transition
       {{ request()->routeIs('admin.survei-jawaban.index')
           ? 'bg-red-50 text-red-700 font-semibold shadow-sm'
           : 'text-gray-700 hover:bg-gray-100' }}">
            <i class="bi bi-bar-chart-line"></i>
            Hasil &amp; Analitik Survei
        </a>
