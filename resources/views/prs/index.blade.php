    ...
    <main class="mb-6">
        ...
        <section class="hero max-w-7xl mx-auto py-8">
            <div class="px-3 md:px-5 relative">
                <h1 class="text-2xl md:text-4xl font-bold text-red-600">Produk <span class="text-black"> Statistik OPD</span>
                </h1>
                <p class="text-lg md:text-2xl">Provinsi Sumatera Selatan</p </div>
        </section>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="w-32 flex-shrink-0">
                                <div class="w-full h-40 bg-gray-100 flex items-center justify-center rounded">
                                    <img src="{{ asset('storage/prs/thumbnail/' . $item->thumbnail) }}" alt="Cover Image"
                                        width="128" class="object-cover rounded">
                            ...
                            <div class="flex-1">
                                ...
                                <h3 class="text-base font-semibold text-gray-800">
                                    <a href="{{ route('detail.prs', $item->id) }}"> {{ $item->title }}</a>
                                </h3>
                                ...
                                <a href="{{ asset('storage/prs/' . $item->document) }}"
