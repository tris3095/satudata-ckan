    ...
    <main class="mb-6">
        ...
        <section class="hero max-w-7xl mx-auto py-8">
            <div class="px-6 relative">
                <h1 class="text-4xl font-bold text-red-600">Web<span class="text-black">inar</span></h1>
                <p class="mt-2 text-2xl">Satudata Provinsi Sumatera Selatan</p>
            </div>
        </section>
        ...
        <section class="max-w-7xl mx-auto">
            ...
            <div class="section-content px-6">
                @if ($datas->isEmpty())
                    <p class="text-gray-500">No Webinar available.</p>
                @else
